export const incidents = [
...

  {
    ...
    published: true,
    opened: "2026-09-17T09:18:00-04:00",
    restored: "",
    created: "2026-09-17T09:18:00-04:00",
    closed: "",
    ...
    scenes: [
      {
        ...
        summary: "The Santiago WMS application is unavailable because the primary link failed, even though the backup path and WMS server farm remain operational.",
        camera: { mode: "fit-scene", focus: "affected-service", zoom: 1.04 },
        nodes: [
          { id: "affected-service", label: "Santiago WMS App", subtitle: "FAILED", role: "affected-service", selected: true, status: "failed", position: { q: 0, r: 0 } },
          { id: "santiago-warehouse", label: "Santiago Warehouse", subtitle: "IMPACTED", role: "site", status: "degraded", position: { q: 4, r: 0 } },
          { id: "main-link", label: "Main Link", subtitle: "FAILED", role: "dependency", status: "failed", position: { q: 8, r: -4 } },
          { id: "backup-link", label: "Backup Link", subtitle: "ACTIVE", role: "dependency", status: "healthy", position: { q: 4, r: 4 } },
          { id: "datacenter", label: "Santo Domingo Datacenter", subtitle: "OPERATIONAL", role: "infrastructure", status: "healthy", position: { q: 8, r: 0 } },
          { id: "wms-server-01", label: "WMS Server 01", subtitle: "OPERATIONAL", role: "service", status: "healthy", position: { q: 12, r: -4 } },
          { id: "wms-server-02", label: "WMS Server 02", subtitle: "OPERATIONAL", role: "service", status: "healthy", position: { q: 12, r: 0 } },
          { id: "wms-server-03", label: "WMS Server 03", subtitle: "OPERATIONAL", role: "service", status: "healthy", position: { q: 8, r: 4 } },
        ],
        connectors: [
          { from: "affected-service", to: "santiago-warehouse", label: "site" },
          { from: "santiago-warehouse", to: "main-link", label: "primary path" },
          { from: "santiago-warehouse", to: "backup-link", label: "backup path" },
          { from: "main-link", to: "datacenter", label: "unavailable" },
          { from: "backup-link", to: "datacenter", label: "active" },
          { from: "datacenter", to: "wms-server-01", label: "service pool" },
          { from: "datacenter", to: "wms-server-02", label: "service pool" },
          { from: "datacenter", to: "wms-server-03", label: "service pool" },
        ],
        highlights: [
          "The primary link from Santiago is unavailable.",
          "The backup link reaches the Santo Domingo datacenter.",
          "All three WMS servers remain operational, but the application is still unavailable from Santiago.",
        ],
        inspector: {
          title: "Investigation in progress",
          body: "The map separates path availability from application reachability: the main link failed, the backup link is active, and the WMS farm remains healthy while Santiago still cannot use the application.",
          facts: ["Status: Open", "Severity: SEV-2", "Affected service: Santiago WMS App", "Opened: 09:18"],
        },
        actions: [],
        nextScene: "overview",
      },
