    ...
    scenes: [
      {
        ...
        nodes: [
          { id: "incident-core", label: "Authentication Service Disruption", role: "incident-core" },
        ...
        connectors: [
          { from: "incident-core", to: "incident-status", label: "state" },
          { from: "incident-core", to: "incident-severity", label: "severity" },
          { from: "incident-core", to: "incident-duration", label: "duration" },
          { from: "incident-core", to: "incident-organization", label: "organization" },
          { from: "incident-core", to: "incident-requester", label: "requester" },
          { from: "incident-core", to: "incident-service", label: "service" },
          { from: "incident-core", to: "incident-affected", label: "impact" },
          { from: "incident-core", to: "incident-category", label: "cause" },
        ],
        highlights: [
