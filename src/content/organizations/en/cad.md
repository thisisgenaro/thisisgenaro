...
topology:
  nodes:
    - { id: storefront, label: Storefront, subtitle: CUSTOMER EDGE, q: -7, r: -2, status: healthy, variant: root, size: lg, selected: true }
    - { id: cdn, label: CDN, subtitle: DELIVERY, q: -3, r: -4, status: healthy }
    - { id: checkout, label: Checkout API, subtitle: PURCHASE FLOW, q: 2, r: -4, status: healthy, variant: anchor }
    - { id: payment, label: Payment Gateway, subtitle: EXTERNAL, q: 6, r: -2, status: degraded, variant: anchor }
    - { id: loyalty, label: Loyalty Platform, subtitle: CUSTOMER, q: -5, r: 3, status: healthy }
    - { id: erp, label: ERP, subtitle: OPERATIONS, q: 0, r: 2, status: healthy }
    - { id: inventory, label: Inventory Sync, subtitle: AVAILABILITY, q: 5, r: 3, status: degraded }
    - { id: wms, label: WMS, subtitle: FULFILLMENT, q: -3, r: 7, status: healthy }
    - { id: stores, label: Store Network, subtitle: 25 LOCATIONS, q: 3, r: 7, status: healthy }
    - { id: monitoring, label: Monitoring, subtitle: INTERNAL VIEW, q: 7, r: 6, status: healthy }
  relationships:
