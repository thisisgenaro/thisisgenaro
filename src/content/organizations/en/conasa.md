...
topology:
  nodes:
    ...
    - { id: digital-banking, domainId: financial, label: Digital Banking, subtitle: MEMBER ACCESS, status: healthy }
    - { id: branch-services, domainId: network, label: Branch Services, subtitle: 18 LOCATIONS, status: healthy, variant: anchor }
    - { id: netscaler, domainId: network, label: NetScaler, subtitle: ACCESS, status: healthy }
    - { id: exchange, domainId: messaging, label: Exchange, subtitle: ON-PREMISES, status: degraded }
    ...
    - { id: reporting, domainId: financial, label: Reporting, subtitle: COMPLIANCE, status: healthy }
  relationships:
