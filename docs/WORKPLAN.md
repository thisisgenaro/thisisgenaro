...
- Incident detail uses the OTF scene sequence with the persistent dormant grid and inspector.
- Journal entries should stay Markdown-driven and narrative.
- About Me should remain a single authored page.
